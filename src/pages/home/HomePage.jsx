...
const HomePage = () => {
    ...
    useEffect(() => {
        if (localStorage.getItem("token")) getCardFromServer(userData, initialDataFromServer, setDataFromServer, "/cards/my-cards");
        else getCardFromServer(userData, initialDataFromServer, setDataFromServer, "/cards");
    }, []);
    useEffect(() => {
